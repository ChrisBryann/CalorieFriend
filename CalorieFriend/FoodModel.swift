...
struct RecipeManager {
    ...
    func fetchRecipes(completion: @escaping (Response) -> Void) {
        let app_id = "924797ad"
        let app_key = "1c303b7a13757ae604f986bd6cb5ddba"
        let url = URL(string: "https://api.edamam.com/api/recipes/v2?type=public&q=chocolate&app_id=\(app_id)&app_key=\(app_key)&calories=500")
